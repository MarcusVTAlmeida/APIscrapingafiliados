...
def get_shopee_product_info(product_url):
    ...
    # 🔹 Buscar infos básicas via API
    payload_product = {
        "query": f"""query {{ productOfferV2(itemId:{item_id}) {{ nodes {{ productName priceMin priceMax imageUrl }} }} }}"""
    }
    ...
    if nodes:
        ...
        if price_max:
            preco_atual = price_max / 100000  # preço com desconto
