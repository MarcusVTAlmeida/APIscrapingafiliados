...
def get_product_info_magalu(product_url):
    try:
        if "magazinevoce.com.br" in product_url:
            ...
            affiliate_link = f"https://www.magazinevoce.com.br/magazine_{MAGALU_STORE}{path}"


        # Testa se o link funciona
        ...
        # Ainda não temos preço confiável
        ...
        print("Erro Magalu:", e)
        # Aqui, ainda devolvemos o link para não quebrar o fluxo
