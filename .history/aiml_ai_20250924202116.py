...
def gerar_legenda_divertida(nome, preco, loja):
    prompt = f"Crie uma legenda divertida e curta (1-2 frases) para um produto de venda online. Produto: {nome}, Preço: {preco}, Loja: {loja}. Use emojis, sem hashtags, estilo social media, única para este produto."
